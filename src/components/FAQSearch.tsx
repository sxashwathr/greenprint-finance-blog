  ...
  return (
    <div className="relative max-w-md mx-auto mb-8">
      ...
      <input
        ...
        className="w-full pl-10 pr-4 py-3 border border-border rounded-lg bg-background focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
        style={{ 
          color: '#6B5B47'
        }}
      />
